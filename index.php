    ...
    <div id="startcontent">
        <div id="feature">
            <div class="featureSlot fade"
                ...
                <div class="overlay">
                    <img class="arrow" src="/assets/images/icons/left-arrow.avif" onclick="plusSlides(-1)">
                    <h2 class="gametext stroke-text smooth-16">MONKEY MART</h2>
                    <img class="arrow" src="/assets/images/icons/right-arrow.avif" onclick="plusSlides(1)">
                </div>
