        ...
        <div id="feature">
            <div class="featureSlot fade"
                ...
                <button onclick="window.open('class.php?class=Monkey-Mart', '_self')" class="featureButton button">Play
                    Now <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512" style="color: #ffffff;"><path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg></button>
            </div>
            ...
            <div class="featureSlot fade"
                ...
                <button onclick="window.open('class.php?class=Bob-the-Robber-2', '_self')"
                    class="featureButton button">Play Now <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512" style="color: #ffffff;"><path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg></button>
            </div>
            ...
            <div class="featureSlot fade"
                ...
                <button onclick="window.open('class.php?class=Moto-X3M-Pool-Party', '_self')"
                    ...
                    Now <svg xmlns="http://www.w3.org/2000/svg" height="1em" style="color: #ffffff;" viewBox="0 0 320 512"><path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"/></svg></button>
            </div>
