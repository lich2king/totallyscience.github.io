...
<body>
    ...
    <div id="articleDiv" style="display:none">
        <div class="container">
            ...
            <div class="center" style="text-align:center" id="readMoreB">
                <a onclick="document.getElementById('article').style.fontSize=''; document.getElementById('readMoreB').style.display='none';"
                    target="_blank" class="button-effect-a"
                    style="color: var(--dark-accent); text-decoration: underline; cursor:pointer;">Read
                    More</a>
            </div>
            <div id="article" style="font-size: 0px;">
    ...
    <script src="assets/scripts/class.js?v218"></script>
</body>
