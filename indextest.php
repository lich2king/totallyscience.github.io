...
<head>
    ...
    <link rel='stylesheet' href='assets/styles/indextest.css?v6'>
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="info">
        ...
        <p>Click <span style="cursor:pointer; color: var(--accent-color)">here</span> to view alternate links</p>
    </div>
    ...
    <script src="assets/scripts/indexnew.js?v18"></script>
</body>
