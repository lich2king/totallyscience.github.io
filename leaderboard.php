    ...
    <div id="highscores">
        <div id="submitB">
            <button class="button" onclick="window.open('submithighscore.php', '_self')"><span>Submit Highscore</span>
                <img style="padding-left:0.5vw" width="16vw" src="https://www.cooperlighting.com/s/vividtune/png/right-arrow.png">
            </button>
        </div>
    </div>
        ...
        window.addEventListener('load', async () => {
            ...
            searchBar.addEventListener('keyup', () => {
                ...
                for (highscore in highscoreDivs) {
                    if (highscoreDivs[highscore].getAttribute('name').toUpperCase().includes(input)) highscoreDivs[highscore].setAttribute('style', 'display:');
