! function(t) {
                ...
                s.noConflict = function() {
                    ...
                    s.report = function() {
                        ...
                        function d(n, e, i, r, d) {
                            if (o)
                                s.computeStackTrace.augmentStackTraceWithInitialElement(o, e, i, n),
                                c();
                            else if (d)
                                a(s.computeStackTrace(d), !0, d);
                            else {
                                var l,
                                    A = {
                                        url: e,
                        ...
                        function u(t) {
                            if (!A(e && e.document)) {
                                ...
                                if (r = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(l)) {
                                    ...
                                    n = o(r[3]).replace(/;$/, ";?"),
                                        i = new RegExp("function" + p + "\\s*\\(\\s*" + g + "\\s*\\)\\s*{\\s*" + n + "\\s*}")
                                } else
                                ...
                                if (r = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(l)) {
                                    var h = r[1];
                                    if (n = a(r[2]), s = d(i = new RegExp("on" + h + "=[\\'\"]\\s*" + n + "\\s*[\\'\"]", "i"), c[0]))
                                        return s;
                                    if (s = d(i = new RegExp(n), c))
                                        return s
                                }
                                return null
                            }
                        ...
                        function m(t) {
                            ...
                            for (var n, e, o, a = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, d = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, u = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, l = /\((\S*)(?::(\d+))(?::(\d+))\)/, m = t.stack.split("\n"), f = [], p = /^(.*) is undefined$/.exec(t.message), g = 0, h = m.length; g < h; ++g) {
                                if (e = a.exec(m[g])) {
                                    ...
                                    e[2] && 0 === e[2].indexOf("eval") && (n = l.exec(e[2])) && (e[2] = n[1], e[3] = n[2], e[4] = n[3]),
                                        o = {
                                            url: w ? null : e[2],
                                            func: e[1] || "?",
                                            args: w ? [e[2]] : [],
                                    ...
                                    if (!(e = s.exec(m[g])))
                                        continue;
                                    e[3] && e[3].indexOf(" > eval") > -1 && (n = u.exec(e[3])) ? (e[3] = n[1], e[4] = n[2], e[5] = null) : 0 !== g || e[5] || A(t.columnNumber) || (f[0].column = t.columnNumber + 1),
                                        o = {
                                            url: e[3],
                                            func: e[1] || "?",
                                            args: e[2] ? e[2].split(",") : [],
                            ...
                            for (var e, r, o, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, d = [], l = {}, A = !1, m = p.caller; m && !A; m = m.caller)
                                if (m !== g && m !== s.report) {
                                    if (r = {
                                            ...
                                            line: null,
                                            column: null
                                        }, m.name ? r.func = m.name : (e = a.exec(m.toString())) && (r.func = e[1]), void 0 === r.func)
                                        try {
                                ...
                                if (s = function(t) {
                                        ...
                                        for (var h = 2; h < o.length; h += 2) {
                                            ...
                                            if (w) {
                                                ...
                                                x && T.replace(/^\s*/, "") === o[h + 1].replace(/^\s*/, "") ? w.context = x : w.context = [o[h + 1]],
                                                    m.push(w)
                                            }
                                        }
                                        return m.length ? {
    ...
    (t.exports = function(t, n, e, s) {
        var d = !!s && !!s.unsafe,
            c = !!s && !!s.enumerable,
            A = !!s && !!s.noTargetGet;
        "function" == typeof e && ("string" != typeof n || o(e, "name") || r(e, "name", n), u(e).source = l.join("string" == typeof n ? n : "")),
            t !== i ? (d ? !A && t[n] && (c = !0) : delete t[n], c ? t[n] = e : r(t, n, e)) : c ? t[n] = e : a(n, e)
    ...
    t.exports = function(t, n) {
        var e,
            ...
            c = [];
        for (e in s)
            !i(a, e) && i(s, e) && c.push(e);
        for (; n.length > d;)
            i(s, e = n[d++]) && (~o(c, e) || c.push(e));
        return c
    }
}, function(t, n, e) {
    var i = e(31),
    ...
    var i,
        ...
        l = c("iterator"),
        A = !1;
    [].keys && ("next" in (o = [].keys()) ? (r = a(a(o))) !== Object.prototype && (i = r) : A = !0),
        null == i && (i = {}),
        u || d(i, l) || s(i, l, (function() {
            return this
        })),
        t.exports = {
            IteratorPrototype: i,
    ...
    t.exports = !u || r((function() {
        ...
        for (var e = d(t), r = arguments.length, u = 1, l = a.f, A = s.f; r > u;)
            for (var m, f = c(arguments[u++]), p = l ? o(f).concat(l(f)) : o(f), g = p.length, h = 0; g > h;)
                m = p[h++],
                i && !A.call(f, m) || (e[m] = f[m]);
        return e
    } : u
}, function(t, n, e) {
    e(79),
        ...
        $ = function(t, n) {
            E.call(c, (function() {
                ...
                if (tt(n) && (e = I((function() {
                    ...
                    })), n.rejection = H || tt(n) ? 2 : 1, e.error))
                    throw e.value
            }))
        },
        tt = function(t) {
    ...
    ! function(t) {
        ...
        function f(t) {
            this.map = {},
                t instanceof f ? t.forEach((function(t, n) {
                    this.append(n, t)
        ...
        function v(t, n) {
            ...
            if (t instanceof v) {
                ...
                this.url = String(t);
            if (this.credentials = n.credentials || this.credentials || "omit", !n.headers && this.headers || (this.headers = new f(n.headers)), this.method = (e = n.method || this.method || "GET", i = e.toUpperCase(), c.indexOf(i) > -1 ? i : e), this.mode = n.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && r)
    ...
    "document" in window.self && ((!("classList" in document.createElement("_")) || document.createElementNS && !("classList" in document.createElementNS("http://www.w3.org/2000/svg", "g"))) && function(t) {
        ...
        if ("Element" in t) {
            var n = t.Element.prototype,
                ...
                s = function(t) {
                    for (var n = i.call(t.getAttribute("class") || ""), e = n ? n.split(/\s+/) : [], r = 0, o = e.length; r < o; r++)
                        this.push(e[r]);
    ...
    var s,
        ...
        f = function() {
            ...
            return t.clearEventListeners = function() {
                ...
                if (void 0 === e && (e = !1), e = !!e, Object.prototype.hasOwnProperty.call(this.listeners, t) || (this.listeners[t] = []), e) {
                    var r = function(e) {
                        i.removeEventListener.bind(i)(t, r),
                            n(e)
                    };
        ...
        b = function() {
            ...
            return t.prototype.setTimings = function(t) {
                ...
                var e = this;
                void 0 === n && (n = function() {}),
                    this.getTiming(t) <= 0 ? n() : (this.timers[t] && clearTimeout(this.timers[t]), this.timers[t] = setTimeout((function() {
                        e.stopTimer(t),
                            n()
                    }), this.getTiming(t)))
    ...
    var G = function() {
            ...
            return t.prototype.moveThroughWaterfall = function() {
                ...
                if (this.debug) {
                    var e = "https://example.com/gampad/ads?sz=640x360|640x480&iu=/21682198607/debug-video/";
                ...
                bt.childDirected && (r += "&tfcd=1"),
                    ...
                    1 !== this.retries || E() || x() ? (console.debug("adRequest started in plain mode"), this.ima.requestAd(r)) : (console.debug("adRequest started with Prebid Video enabled"), function(t, n, e, i) {
                        if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
                                ...
                                c = function() {
                                    if (!(--d > 0))
                                        try {
                                            ...
                                            if ("undefined" === i)
                                                return console.error("Video-ad-unit not found, did you give it the adunit.code='video' value?"), void t.requestAd(n);
                            ...
                            R && (d++, window.apstag.fetchBids({
                                    ...
                                    t.length > 0 && (r = t[0].encodedQsParams),
                                        c()
                                }))),
                                window.pbjs.que.push((function() {
            ...
            function s(o) {
                return function(s) {
                    return function(o) {
                        ...
                        for (; a;)
                            try {
                                if (e = 1, i && (r = 2 & o[0] ? i.return : o[0] ? i.throw || ((r = i.return) && r.call(i), 0) : i.next) && !(r = r.call(i, o[1])).done)
                                    return r;
        ...
        nt = function() {
            ...
            return t.prototype.initAdDisplayContainer = function() {
                ...
                n.enablePreloading = !0,
                    ...
                    n.mimeTypes = z() || E() || x() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"],
                    ...
                    this.allowedToPlayAd ? (this.attachAdEvents(), f.dispatchEvent(A.ads.ready)) : this.tearDown()
                ...
                switch (t.type) {
                    ...
                    case google.ima.AdEvent.Type.PAUSED:
                        this.adsManager.pause(),
                            f.dispatchEvent(A.ads.video.paused);
                        break;
    ...
    function dt() {
        return at(this, void 0, Promise, (function() {
            ...
            return st(this, (function(n) {
                switch (n.label) {
                    case 0:
                        return n.trys.push([0, 3, , 4]), [4, fetch("https://example.com/", {
                            method: "GET",
                            headers: {
    ...
    var ct = e(67),
        ...
        wt = function(t, n) {
            ...
            var o = function(t) {
                ...
                return pt || (e = bt.GetIsPokiIFrame() ? "/21682198607/" + i + "_ingame_" + t + "/" + r + "_" + i + "_ingame_" + t : "/21682198607/external_" + i + "_display_ingame/external_" + i + "_ingame_" + t), {
                    id: "poki-" + ft(),
                    adUnitPath: e,
                    size: t,
                    width: n[0],
            ...
            return gt.set(o.id, o), googletag.cmd.push((function() {
                ...
                n.id = o.id,
                    ...
                    o.gptSlot = googletag.defineSlot(o.adUnitPath, [o.width, o.height], o.id).addService(googletag.pubads()),
            ...
            return t.prototype.init = function(t) {
                if (void 0 === t && (t = {}), "undefined" != typeof window) {
                    ...
                    var n = t.onReady,
                        ...
                        i = t.onAdblocked,
                        r = void 0 === i ? null : i;
                    return this.initOptions = t, e && this.registerHandler("onReady", e), r && this.registerHandler("onAdblocked", r), this.setupDefaultEvents(), y.setupDefaultEvents(), "true" === encodeURIComponent(T("lazy") || "") ? (console.debug("Init in Lazy mode"), new Promise((function(t) {
                        return t()
                ...
                return P && (_ = function() {
                    ...
                    if (void 0 !== n) {
                        ...
                        if (i) {
                            ...
                            ["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(kt.gameId) && (E() || x()) && mt(),
                ...
                var i = function() {
                    var i = n.autoStart,
                        ...
                        l = n.position,
                        m = void 0 === l ? null : l;
                    if (e.autoStartOnReady = !1 !== r, d && e.registerHandler("onFinish", d), u && e.registerHandler("onStart", u), e.forceDisableCommercialBreak && [A.ads.position.midroll, A.ads.position.preroll].includes(m))
                        d && d();
                    else {
                        if (!e.sdkBooted)
                        ...
                        if (e.sdkImaError)
                            ...
                            if (m === A.ads.position.rewarded || e.adTimings.requestPossible()) {
                                ...
                                (t.isPokiPlatform || m === A.ads.position.rewarded) && (g = vt(vt({}, g), a)),
                ...
                var n = this,
                    e = function() {
                        if (!n.sdkBooted)
                            return f.dispatchEvent(A.ads.displayError, {
    ...
    function Ct(t) {
        if (kt.gameId && kt.versionId) {
            if (!(Date.now() < Tt)) {
                zt || function(t, n, e) {
                    document.cookie = t + "=" + n + "; path=/; max-age=" + (e || 63072e3) + "; domain=" + Et
    ...
    function Pt(t) {
        ...
        try {
            if (t.__poki__)
                return t;
            if (t.__poki_wrapper__)
                return t.__poki_wrapper__
        } catch (n) {
            return t
        }
                ...
                this.gameStarted = !1,
                    ...
                    this.gameplayStart = function(n) {
                        t.gameplayStartCounter++,
                            t.gameStarted || (t.gameStarted = !0, y.track(A.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()),
                            y.track(A.tracking.screen.gameplayStart, Lt(Lt({}, n), {
                    ...
                    this.gameplayStop = function(n) {
                        t.gameplayStopCounter++,
                            y.track(A.tracking.screen.gameplayStop, Lt(Lt({}, n), {
                                playId: t.gameplayStartCounter,
                    ...
                    this.customEvent = function(n, e, i) {
                        void 0 === i && (i = {}),
                            n && e ? (n = String(n), e = String(e), i = Lt({}, i), y.track(A.tracking.custom, {
                                eventNoun: n,
                                eventVerb: e,
                                eventData: i
                    ...
                    this.happyTime = function(n) {
                        void 0 === n && (n = 1),
                            ((n = Number(n)) < 0 || n > 1) && (n = Math.max(0, Math.min(1, n)), t.warning("happyTime", "Intensity should be a value between 0 and 1, adjusted to " + n)),
                    ...
                    this.sendHighscore = function(t) {
                        y.track(A.tracking.screen.sendHighscore, {
                            score: t
                        })
                    },
