!function(t, i, e) {
    var s = (e.un, e.uns, e.static), n = e.class, h = e.getset, o = (e.__newvec, laya.display.Animation), r = laya.utils.Browser, a = laya.utils.ClassUtils, l = laya.filters.ColorFilter, c = laya.components.Component, u = (laya.Const, 
    ...
    var T = function() {
        ...
        function i() {
            i.__super.call(this), this._top = 0 / 0, this._bottom = 0 / 0, this._left = 0 / 0, 
            this._right = 0 / 0, this._centerX = 0 / 0, this._centerY = 0 / 0;
        }
        n(i, "laya.ui.Widget", t);
        var e = i.prototype;
        return e.onReset = function() {
            this._top = this._bottom = this._left = this._right = this._centerX = this._centerY = 0 / 0;
        ...
        function i() {
            ...
            this._gray = !1, i.__super.call(this), this._anchorX = 0 / 0, this._anchorY = 0 / 0, 
        ...
        function i() {
            ...
            H.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null);
        }
        ...
        return s._closeOnSide = function() {
            ...
            this.lockLayer || (this.lockLayer = new G(), this.lockLayer.mouseEnabled = !0, this.lockLayer.size(e.stage.width, e.stage.height)), 
            this.lockLayer.removeChildren(), t && (t.centerX = t.centerY = 0, this.lockLayer.addChild(t));
        }, s._onResize = function() {
            var t = this.maskLayer.width = e.stage.width, i = this.maskLayer.height = e.stage.height;
            this.lockLayer && this.lockLayer.size(t, i), this.maskLayer.graphics.clear(!0), 
            this.maskLayer.graphics.drawRect(0, 0, t, i, H.popupBgColor), this.maskLayer.alpha = H.popupBgAlpha;
            ...
            for (var t = this.numChildren - 1; t > -1; t--) {
                var i = this.getChildAt(t);
                if (i && i.isModal) return this.addChildAt(this.maskLayer, t), void 0;
            }
        }, i;
    }(x), X = function(t) {
        function i() {
            this._watchMap = {}, this._widget = null, this._dataSource = null, this._anchorX = 0 / 0, 
            this._anchorY = 0 / 0, this._widget = P.EMPTY, i.__super.call(this);
        }
        n(i, "laya.ui.View", t);
        var s = i.prototype;
        return s.destroy = function(i) {
            ...
            a.regShortClassName([ si, U, gi, V, G, li, U, ci, j, F, Y, K, ri, R, W, oi, ti, $, ai, di, E, N, _i, ii, i, J, Q, ni, hi, fi, pi, x, o, B, ui ]);
        }, i;
    }(S), E = function(t) {
        function i(t) {
            ...
            this._isElastic = !1, this._value = 0 / 0, this._hide = !1, this._clickOnly = !0, 
            this._offsets = null, this.isLockedFun = null, this.triggerDownDragLimit = null, 
            this.triggerUpDragLimit = null, i.__super.call(this), this._showButtons = H.showButtons, 
            this._touchScrollEnable = H.touchScrollEnable, this._mouseWheelEnable = H.mouseWheelEnable, 
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this.slider = new N()), this.addChild(this.upButton = new U()), this.addChild(this.downButton = new U());
            ...
            this._isElastic) this._value < this.min ? L.to(this, {
                ...
                for (var t = 0, i = Math.min(this._offsets.length, 3), s = 0; i > s; s++) t += this._offsets[this._offsets.length - 1 - s];
                if (this._lastOffset = t / i, t = Math.abs(this._lastOffset), 2 > t) return this.event("end"), 
                void 0;
                t > 250 && (this._lastOffset = this._lastOffset > 0 ? 250 : -250);
            ...
            if (this._lastOffset *= this.rollRatio, !this.checkTriggers(!0)) {
                ...
                this.value -= this._lastOffset, Math.abs(this._lastOffset) < .1) {
                    if (e.timer.clear(this, this.tweenMove), this._isElastic) return this._value < this.min ? L.to(this, {
                        value: this.min
                    }, this.elasticBackTime, u.sineOut, f.create(this, this.elasticOver)) : this._value > this.max ? L.to(this, {
                        value: this.max
        ...
        function i(t) {
            this._bitmap = null, this._skin = null, this._group = null, this.priority = 1, i.__super.call(this), 
            this.skin = t;
        }
        n(i, "laya.ui.Image", t);
        var s = i.prototype;
        return s.destroy = function(i) {
            ...
            this.graphics = this._bitmap = new O(), this._bitmap.autoCacheCmd = !1;
            ...
            if (this._skin != t) if (this._skin = t, t) {
                var i = m.getRes(t);
                i ? (this.source = i, this.onCompResize()) : e.loader.load(this._skin, f.create(this, this.setSource, [ this._skin ]), null, "image", this.priority, !0, this._group);
            } else this.source = null;
        }), h(0, s, "sizeGrid", function() {
            return this._bitmap.sizeGrid ? this._bitmap.sizeGrid.join(",") : null;
        }, function(t) {
            this._bitmap.sizeGrid = T.fillArray(D.defaultSizeGrid, t, Number);
        ...
        function i(t) {
            ...
            this._bg = null, this._progress = null, this._bar = null, this._tx = 0 / 0, this._ty = 0 / 0, 
            this._maxMove = 0 / 0, this._globalSacle = null, i.__super.call(this), this.skin = t;
        }
        ...
        return o.destroy = function(i) {
            ...
            this.addChild(this._bg = new R()), this.addChild(this._bar = new U());
            ...
            this._value != t && this.sendChangeEvent(), this.showValueText();
            ...
            m.getRes(t) && (this._progress || (this.addChild(this._progress = new R()), this._progress.sizeGrid = this._bar.sizeGrid, 
            ...
            this._progress && (this._progress.width = this._bar._x + .5 * this._bar.width));
        }, o.onBgMouseDown = function() {
            var t = this._bg.getMousePoint();
            this.value = this.isVertical ? t.y / (this.height - this._bar.height) * (this._max - this._min) + this._min : t.x / (this.width - this._bar.width) * (this._max - this._min) + this._min;
        ...
        return s.destroy = function(i) {
            ...
            this._tf.padding = T.fillArray(D.labelPadding, t, Number);
        }), h(0, s, "bold", function() {
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this._colorButton = new U()), this._colorPanel = new G(), this._colorPanel.size(230, 166), 
        ...
        return e.imps(o, {
            ...
            this._clickHandler && this._clickHandler.run(), void 0) : (!this._selected && (this.state = i.stateMap[t.type]), 
            void 0);
        }, o._skinLoaded = function() {
            ...
            this.createText(), this._text.padding = T.fillArray(D.labelPadding, t, Number);
            ...
            this._strokeColors = T.fillArray(D.buttonLabelColors, t, String), this._setStateChanged();
        }), h(0, o, "labelColors", function() {
            return this._labelColors.join(",");
        }, function(t) {
            this._labelColors = T.fillArray(D.buttonLabelColors, t, String), this._setStateChanged();
        ...
        var s = i.prototype;
        return s._onStageHideTip = function() {
        ...
        }, s._onStageMouseDown = function() {
            this.closeAll();
        }, s._onStageMouseMove = function() {
        ...
        function i(t, e) {
            ...
            this._itemHeight = 0 / 0, this._listHeight = 0 / 0, this._listChanged = !1, this._itemChanged = !1, 
        ...
        return s.destroy = function(i) {
            ...
            this._list = new oi(), this._scrollBarSkin && (this._list.vScrollBarSkin = this._scrollBarSkin), 
            this._setListEvent(this._list);
        }, s._setListEvent = function() {
            ...
            this._itemColors = T.fillArray(this._itemColors, t, String), this._listChanged = !0;
            ...
            this._button.text.padding = T.fillArray(D.labelPadding, t, Number);
        ...
        return s._dealDragArea = function() {
        ...
        }, s._onMouseDown = function() {
            var t = this.getMousePoint();
            this._dragArea.contains(t.x, t.y) ? this.startDrag() : this.stopDrag();
            ...
            if (i) switch (i.name) {
              ...
              case "ok":
              case "yes":
                return this.close(i.name), void 0;
            }
        }, s.open = function(t, e) {
            ...
            if (t) {
                var i = T.fillArray([ 0, 0, 0, 0 ], t, Number);
            ...
            e.superSet(X, this, "zOrder", t), i.manager._checkMask();
        ...
        return l.getLocalDateString = function(t) {
            ...
            if (this._moreBox) this._moreBox.visible = !0; else {
                this._moreBox = new G(), e.stage.addChild(this._moreBox), this._moreBox.zOrder = 99999, 
                ...
                if (!l) return this.visible = !1, void 0;
                try {
                ...
                this.screenType && (n.spaceY = 10, n.width = 690, n.height = this.isQMP() ? e.stage.height + 130 : 1139, 
        ...
        l.onDrawShapes = function(t, i, e, s) {
            ...
            var t = h._http, i = void 0 !== t.status ? t.status : 200;
            ...
            h._moreGameData.isOpen && this.screenType ? (this._iconImage || (this._iconImage = new R(), 
            ...
            o = function(t) {
                ...
                return e.init = function(t, i, e) {
                    ...
                    l.init(t.gameList[o], i, e); else {
                        this.gameListBox = new G(), this.addChild(this.gameListBox);
        ...
        function i(t, e) {
            ...
            this._labelStroke = 0 / 0, this._labelSize = 0, this._labelBold = !1, this._labelPadding = null, 
        ...
        return e.imps(s, {
            ...
            this._dataSource = t, "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : e.superSet(G, this, "dataSource", t);
        }), i;
    }(G), ti = (function(t) {
        function i(t) {
        ...
        return s.destroy = function(t) {
            ...
            laya.display.Node.prototype.addChild.call(this, this._content = new G());
            ...
            this._usedCache || (this._usedCache = e.superGet(G, this, "cacheAs")), e.superSet(G, this, "cacheAs", "none"), 
            ...
            e.superSet(G, this, "cacheAs", this._usedCache);
            ...
            e.superSet(G, this, "width", t), this._setScrollChanged();
        }), h(0, s, "hScrollBar", function() {
            return this._hScrollBar;
        }), h(0, s, "content", function() {
            return this._content;
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(G, this, "height", t), this._setScrollChanged();
        }), h(0, s, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null;
        }, function(t) {
            null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new Q()), 
            ...
            e.superSet(G, this, "cacheAs", t), this._usedCache = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), 
        ...
        return s.preinitialize = function() {
            ...
            this._bg || (this.graphics = this._bg = new O()), this._bg.source = m.getRes(this._skin), 
            ...
            this._bg || (this.graphics = this._bg = new O()), this._bg.sizeGrid = T.fillArray(D.defaultSizeGrid, t, Number);
        }), h(0, s, "width", t.prototype._$get_width, function(t) {
            e.superSet(W, this, "width", t), this._bg && (this._bg.width = t);
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(W, this, "height", t), this._bg && (this._bg.height = t);
        ...
        return e.imps(s, {
            ...
            this.addChild(this._list = new oi()), this._list.renderHandler = f.create(this, this.renderItem, null, !1), 
            this._list.repeatX = 1, this._list.on("change", this, this.onListChange);
        }, s.onListChange = function() {
            this.event("change");
        }, s.getArray = function() {
            var t, i = [];
            ...
            if (e) {
                ...
                n && (n.index = 2 == n.clipY ? e.isDirectory ? 0 : 1 : e.isDirectory ? e.isOpen ? 1 : 0 : 2), 
            ...
            this._dataSource = t, e.superSet(G, this, "dataSource", t);
        }), h(0, s, "source", function() {
            return this._source;
        }), h(0, s, "scrollBar", function() {
            ...
            e.superSet(G, this, "width", t), this._list.width = t;
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(G, this, "height", t), this._list.height = t;
        ...
        return e.imps(s, {
            ...
            this.addChild(this._content = new G());
        }, s.onScrollStart = function() {
            this._usedCache || (this._usedCache = e.superGet(G, this, "cacheAs")), e.superSet(G, this, "cacheAs", "none"), 
        ...
        }, s.onScrollBarChange = function() {
            this.runCallLater(this.changeCells);
            var t = this._scrollBar.value, i = this._isVertical ? this.repeatX : this.repeatY, e = this._isVertical ? this.repeatY : this.repeatX, s = Math.floor(t / this._cellSize);
            if (this.cacheContent) h = e + 1, this._createdLine - s < h && (this._createItems(this._createdLine, i, this._createdLine + h), 
            this.renderItems(this._createdLine * i, 0), this._createdLine += h); else {
                var n = s * i, h = 0;
                if (n > this._startIndex) {
                    h = n - this._startIndex;
                    var o = !0, r = this._startIndex + i * (e + 1);
                    this._isMoved = !0;
                } else n < this._startIndex && (h = this._startIndex - n, o = !1, r = this._startIndex - 1, 
                this._isMoved = !0);
                for (var a = 0; h > a; a++) {
                    if (o) {
                        ...
                        var c = r + a;
                    } else l = this._cells.pop(), this._cells.unshift(l), c = r - a;
                    var u = Math.floor(c / i) * this._cellSize;
            ...
            for (var e = t._$bindData, s = 0, n = e.length; n > s; s++) {
                var h = e[s++], o = e[s++], r = e[s], a = T.getBindFun(r);
                h[o] = a.call(this, i);
            }
            ...
            e.superSet(G, this, "cacheAs", t), this._scrollBar && (this._usedCache = null, "none" !== t ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart));
        }), h(0, s, "content", function() {
            return this._content;
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            t != this._height && (e.superSet(G, this, "height", t), this._setCellChanged());
        }), h(0, s, "itemRender", function() {
            ...
            t != this._width && (e.superSet(G, this, "width", t), this._setCellChanged());
            ...
            this._dataSource = t, "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : e.superSet(G, this, "dataSource", t);
        ...
        return s.onEnable = function() {
            ...
            if (this.width > 0 && this.height > 0) {
                ...
                e.superSet(G, this, "width", e.stage.width), e.superSet(G, this, "height", e.stage.height), 
                this.scale(t, t);
            }
        }, h(0, s, "width", t.prototype._$get_width, function(t) {
            e.superSet(G, this, "width", t), this._oldW = t;
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(G, this, "height", t), this._oldH = t;
        }), i;
    }(G), ci = function(t) {
        function i(t, e) {
        ...
        return s.preinitialize = function() {
            ...
            this._dataSource = t, "boolean" == typeof t ? this.selected = t : "string" == typeof t ? this.selected = "true" === t : e.superSet(U, this, "dataSource", t);
        }), i;
    }(U), ui = function(t) {
        function i(t, e) {
        ...
        return s.createChildren = function() {
            this._bitmap = new O(), this.on("loaded", this, this._onClipLoaded);
            ...
            e.superSet(j, this, "height", t), this.callLater(this.changeValue);
        }), h(0, s, "direction", function() {
            return this._direction;
        }, function(t) {
            ...
            e.superSet(j, this, "width", t), this.callLater(this.changeValue);
        }), h(0, s, "spaceX", function() {
            return this._spaceX;
        }, function(t) {
        ...
        return s.sortItem = function(t) {
            ...
            this._height != t && (e.superSet(ei, this, "height", t), this.callLater(this.changeItems));
        ...
        return s._onTextChange = function() {
            ...
            e.superSet(ii, this, "width", t), this.callLater(this.changeScroll);
        }), h(0, s, "hScrollBar", function() {
            return this._hScrollBar;
        }), h(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(ii, this, "height", t), this.callLater(this.changeScroll);
        }), h(0, s, "maxScrollX", function() {
            return this._tf.maxScrollX;
        }), h(0, s, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null;
        }, function(t) {
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new Q()), this._vScrollBar.on("change", this, this.onVBarChanged), 
        ...
        return s.changeItems = function() {
            ...
            this._width != t && (e.superSet(ei, this, "width", t), this.callLater(this.changeItems));
