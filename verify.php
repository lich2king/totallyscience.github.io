...
<body>
    ...
    <h1 style="text-align: center; margin-bottom: 50px; margin-top: 100px">You must verify your email address before accessing your account.</h1>
    ...
    <p id="resEmail" onclick="logout()">Logout</p>
