...

{
	const scriptsInEvents = {
		...
		{
			SubmitLeaderboardScore(runtime.globalVars.credits);
		},
		...
		async Game_Event77_Act10(runtime, localVars)
		{
			ExternEval();
		},

		async Game_Event249_Act1(runtime, localVars)
		{
			InitExternEval();
		},
		...
		{
			runtime.globalVars.leaderboardscore = window.myLeaderboardScore;
		},

		async Ads_Event1_Act3(runtime, localVars)
		{
			runtime.globalVars.playerName = window.playerName;
		},
		...
		{
			console.log("Welcome to casino " + runtime.globalVars.playerName);
		},

		async Ads_Event8_Act2(runtime, localVars)
		{
			console.log("Load score " + runtime.globalVars.leaderboardscore);
		}
