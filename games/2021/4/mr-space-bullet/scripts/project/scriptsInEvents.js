...

{
	const scriptsInEvents = {
		...
		async Gamesheet_Event179_Act1(runtime, localVars)
		{
			SubmitLeaderboardScore(runtime.globalVars.Level + 1);
		},
		...
		async Gamesheet_Event489_Act2(runtime, localVars)
		{
			ExternEval();
		},
		...
		async Gamesheet_Event573_Act1(runtime, localVars)
		{
			console.log("Pressed L");
			window.adRunning = 0;
		},

		async Gamesheet_Event579_Act1(runtime, localVars)
		{
			runtime.globalVars.lbScore = window.myLeaderboardScore;
		},
