...

{
	const scriptsInEvents = {
		...
		async Menusheet_Event100_Act8(runtime, localVars)
		{
			console.log(runtime.globalVars.UnlockedKnives);
		},

		async Menusheet_Event171_Act1(runtime, localVars)
		{
			InitExternEval();
		},

		async Gamesheet_Event4_Act1(runtime, localVars)
		{
			ExternEval();
		},
		...
		{
			SubmitLeaderboardScore(runtime.globalVars.BestStage);
		},
