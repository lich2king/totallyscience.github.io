...

{
	const scriptsInEvents = {
		...
		async Game_sheet_Event85_Act1(runtime, localVars)
		{
			SubmitLeaderboardScore(runtime.globalVars.Current_Lvl, 0);
		},
		...
		async Multiplayer_Event83_Act1(runtime, localVars)
		{
			SubmitLeaderboardScore(runtime.globalVars.Current_Lvl, 1);
		}
