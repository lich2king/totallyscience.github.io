...

{
	const scriptsInEvents = {
		...
		async Levelevents_Event84_Act5(runtime, localVars)
		{
			ExternEval();
		},

		async Levelevents_Event86_Act5(runtime, localVars)
		{
			ExternEval();
		},

		async Levelevents_Event88_Act5(runtime, localVars)
		{
			ExternEval();
		},

		async Titlescreenevents_Event1_Act3(runtime, localVars)
		{
			InitExternEval();
		},

		async Titlescreenevents_Event2_Act5(runtime, localVars)
		{
			ExternEval();
		},

		async Titlescreenevents_Event11(runtime, localVars)
		{
