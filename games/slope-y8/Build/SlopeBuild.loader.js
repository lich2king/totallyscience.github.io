function createUnityInstance(e, r, n) {
    ...
    function i(e, r) {
        if ("symbolsUrl" != e) {
            ...
            t || (t = u.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }), "object" != typeof r || "progress" != r.type && "load" != r.type || (t.started || (t.started = !0, t.lengthComputable = r.lengthComputable, t.total = r.total), t.loaded = r.loaded, "load" == r.type && (t.finished = !0));
            var o = 0,
                a = 0,
                i = 0,
                s = 0,
    ...
    function s(e) {
        return new Promise(function(r, n) {
            ...
            t.open("GET", u[e]), t.responseType = "arraybuffer", t.addEventListener("progress", function(r) { i(e, r) }), t.addEventListener("load", function(n) { i(e, n), r(new Uint8Array(t.response)) }), t.send()
        })
    }
    ...
    function l() {
        return new Promise(function(e, r) {
            ...
            }, document.body.appendChild(n), u.deinitializers.push(function() { document.body.removeChild(n) })
        })
    }

    function d() {
        l().then(function(e) { e(u) });
        var e = s("dataUrl");
    ...
    f.forEach(function(r) { e.addEventListener(r, o) }), window.addEventListener("error", t), window.addEventListener("unhandledrejection", t);
    var g = { Module: u, SetFullscreen: function() { return u.SetFullscreen ? u.SetFullscreen.apply(u, arguments) : void u.print("Failed to set Fullscreen mode: Player not loaded yet.") }, SendMessage: function() { return u.SendMessage ? u.SendMessage.apply(u, arguments) : void u.print("Failed to execute SendMessage: Player not loaded yet.") }, Quit: function() { return new Promise(function(r, n) { u.shouldQuit = !0, u.onQuit = r, f.forEach(function(r) { e.removeEventListener(r, o) }), window.removeEventListener("error", t), window.removeEventListener("unhandledrejection", t) }) } };
    return u.SystemInfo = function() {
        function e(e, r, n) { return e = RegExp(e, "i").exec(r), e && e[n] }
        for (var r, n, t, o, a, i, s = navigator.userAgent + " ", l = [
            ...
            if (n = e(l[d][0] + "[/ ](.*?)[ \\)]", s, 1)) { r = l[d][1]; break }
        ...
        for (var u = [
            ...
            if (o = e(u[c][0], s, 1)) { t = u[c][1], o = o.replace(/_/g, "."); break }
