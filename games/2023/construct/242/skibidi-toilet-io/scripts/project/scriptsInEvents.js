...
const scriptsInEvents = {
	...
	async Egame_Event190_Act1(runtime, localVars)
	{
		ExternEval();
	},
	...
	async Eads_Event4_Act3(runtime, localVars)
	{
		runtime.globalVars.adReward = window.adReward;
	},

	async Eads_Event4_Act4(runtime, localVars)
	{
		runtime.globalVars.canReward = window.canReward;
	},

	async Eads_Event9_Act1(runtime, localVars)
	{
		console.log("Pressed K");
		window.adRunning = 1;
	},

	async Eads_Event10_Act1(runtime, localVars)
	{
